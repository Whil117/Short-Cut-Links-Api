    ...
    return (
        <CardNavLink>
            ...
            <CardBurgerButton onClick={handleDisplayOptions}>
                <svg width="26" height="26" viewBox="0 0 26 26" fill="#3C6BB2" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.18796 2H24" stroke="#3C6BB2" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M2.1835 12.9589H23.9901" stroke="#3C6BB2" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M2.18796 23.9177H23.9909" stroke="#3C6BB2" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </CardBurgerButton>
        </CardNavLink>
    )
