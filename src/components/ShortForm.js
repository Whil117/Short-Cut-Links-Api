...
import { CardInput, CardShortButton, CardShortDiv, CardShortDivChildOne } from '../styles/CardShortDivStyled'

export const ShortDiv = ({ submit, change, deleteText }) => {
    return (
        <CardShortDiv>
            <CardShortDivChildOne>
                <CardInput primary required five placeholder="Enter a url..." three="yes" second primary type="url" id="url"  onChange={change} />
            ...
            <div>
                <CardShortButton primary type="submit" onClick={submit}>
