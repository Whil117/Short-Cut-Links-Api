    ...
    return (
        <CardShortDiv>
            <CardShortDivChildOne>
                <CardInput placeholder="Enter a url 'https://'" primary five three="yes" second primary required type="url" id="url" onChange={change} />
            ...
            <div>
                <CardShortButton primary onClick={submit}>
